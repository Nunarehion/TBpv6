import { c as connectMongoDB } from './mongoService-aPNwwyA1.js';
import { c as connectRedis } from './redisService-CH786gXy.js';
import 'mongoose';
import 'ioredis';
...
const handle = sequence(async ({ event, resolve }) => {
  if (!dbInitialized) {
    try {
...
//# sourceMappingURL=hooks.server-DIEgKd7p.js.map
