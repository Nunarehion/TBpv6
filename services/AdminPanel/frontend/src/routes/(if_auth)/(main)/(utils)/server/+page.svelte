    ...
    {:else}
        <div class="metrics-grid">
            ...
            <div class="metric-card">
                ...
                <p class="metric-details">{$serverInfo.ram.usedMemory} GB / {$serverInfo.ram.totalMemory} GB</p>
            </div>
            <div class="metric-card">
                <h3>Дисковое пространство</h3>
                <p class="metric-value">{$serverInfo.disk.usedDiskPercent}%</p>
                <p class="metric-details">{$serverInfo.disk.usedDisk} GB / {$serverInfo.disk.totalDisk} GB</p>
            </div>
        </div>
    {/if}
</div>
